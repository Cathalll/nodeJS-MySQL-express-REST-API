...
router.addRoute("/articles/:nameClassroom?", noop);
...
Named parameters:
    ...
    "/articles/:nameClassroom" will only match routes like "/articles/hello", but *not* "/articles/".

Optional named parameters:

    "/articles/:nameClassroom?" will match "/articles/hello" AND "/articles/"
